package me.rsanchez.mysunshine.data;
...
import me.rsanchez.mysunshine.WeatherContract;
import me.rsanchez.mysunshine.WeatherDbHelper;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        long insertId = insertLocation();

        // Create ContentValues of what you want to insert
        // (you can use the createWeatherValues TestUtilities function if you wish)

        ContentValues contentValues = TestUtilities.createWeatherValues(insertId);

        // Insert ContentValues into database and get a row ID back
        long weatherId = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, contentValues);
